...
Report generated by Web X Sider v5.0`;
  ...
  function addTabs() {
    ...
    const newTabs = [
      ...
      ["shortcuts", "fas fa-keyboard", "Shortcuts"],
      ["wordlist", "fas fa-file-lines", "Wordlists"],
      ["profiles", "fas fa-sliders", "Profiles"],
      ["alerts", "fas fa-bell", "Alerts"],
      ["compliance", "fas fa-clipboard-check", "Compliance"],
      ["api", "fas fa-plug", "API"],
      ["i18n", "fas fa-language", "Language"],
      ["theme", "fas fa-palette", "Theme"],
      ["accessibility", "fas fa-universal-access", "A11y"]
    ];
